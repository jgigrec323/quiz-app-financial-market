...
import { questions } from "@/app/utils/FinancialMarket";
  ...
  return (
    <div className="h-screen w-full flex flex-col items-center mt-20 ">
      <h1 className="mb-10 text-xl font-bold">
        Welcome to the financial market quiz app
      </h1>
      ...
      <div className="flex gap-2 justify-center flex-wrap">
        ...
        <button
          onClick={() => {
            sessionStorage.setItem("numberOfQuestions", 50);
            router.push("/quiz");
          }}
          className="btn"
        >
        ...
        <button
          onClick={() => {
            sessionStorage.setItem("numberOfQuestions", 60);
            router.push("/quiz");
          }}
          className="btn"
        >
